package javaPrep.datastructure;

import javaPrep.datastructure.hashtable.HashTableByArray;
...
public class Main {
    ...
    public static void main(String[] args) {
        ListByArray<String> myList = new ListByArray<>();
        HashTableByArray<String, String> hashMap = new HashTableByArray<>();
        ...
        ListByArray<String> elements = new ListByArray<>();
